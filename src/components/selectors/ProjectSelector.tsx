    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      {projects.length === 0 && (
        <div className="flex items-start gap-2 p-3 bg-amber-900/20 border border-amber-700/50 rounded-lg">
          ...
          <div>
            <p className="text-amber-300 font-medium text-sm">Projeto necessario</p>
            <p className="text-amber-400/70 text-xs mt-0.5">Voce precisa criar um projeto antes de gerar cobranças</p>
          </div>
        </div>
      )}
